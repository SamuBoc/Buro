...
class HU34SolicitudEliminacionSeguridadTest(TestCase):
    def setUp(self):
        self.client = Client()
...
class HU34SolicitudEliminacionRegistroTest(TestCase):
    def setUp(self):
        self.client = Client()
...
class HU34SolicitudEliminacionListadoTest(TestCase):
    def setUp(self):
        self.client = Client()
