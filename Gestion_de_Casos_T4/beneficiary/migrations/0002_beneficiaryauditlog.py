# Generated by Django 6.0.4 on 2026-04-11 18:49
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True, max_length=30, verbose_name="Documento"
                    ),
                ),
                (
                    "beneficiary_name",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["beneficiary", "-timestamp"],
                        name="beneficiary_benefic_31f428_idx",
                    ),
                    models.Index(
                        fields=["user", "-timestamp"],
                        name="beneficiary_user_id_d2804d_idx",
                    ),
                    models.Index(
                        fields=["action"], name="beneficiary_action_bde564_idx"
                    ),
                ],
            },
        ),
